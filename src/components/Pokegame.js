...
class Pokegame extends Component {
    ...
    render() {
        ...
        while(handOne.length < handTwo.length) {
            ...
            let randPokemon = handTwo.splice(randIdx, 1)[0]; // remove one element at random index; since splice returns new array, [0] is immediately taking the element we spliced at 0 index and assigning to randPokemon
